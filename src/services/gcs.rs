...
impl GcsService {
    ...
    pub async fn upload_file_data(&self, file_data: Vec<u8>, remote_path: &str) -> Result<String> {
        log::info!("Uploading file data ({} bytes) to gs://{}/{}", file_data.len(), self.bucket_name, remote_path);
